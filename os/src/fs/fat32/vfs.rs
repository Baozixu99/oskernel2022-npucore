...
pub struct Inode {
    ...
    file_cache_mgr: PageCacheManager,           //指向管理该inode的PageCacheManager
    file_type: Mutex<DiskInodeType>,            //文件或目录
    parent_dir: Mutex<Option<(Arc<Self>, u32)>>,//父目录指针
    fs: Arc<EasyFileSystem>,                    //磁盘块管理器
