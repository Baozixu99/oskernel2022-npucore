...
impl RecycleAllocator {
    ...
    pub fn get_allocated(&self) -> usize {  //计算已分配的资源数量
...
pub fn trap_cx_bottom_from_tid(tid: usize) -> usize {  //计算指定线程tid对应的陷阱上下文的底部地址
    TRAP_CONTEXT_BASE - tid * PAGE_SIZE
}

pub fn ustack_bottom_from_tid(tid: usize) -> usize {      //计算指定线程tid对应的用户栈的底部地址
