...
pub struct Rusage {
    ...
    ru_maxrss: isize,      // NOT IMPLEMENTED /* maximum resident set size */  尚未实现
    ru_ixrss: isize,       // NOT IMPLEMENTED /* integral shared memory size */ 尚未实现
    ru_idrss: isize,       // NOT IMPLEMENTED /* integral unshared data size */ 尚未实现
    ru_isrss: isize,       // NOT IMPLEMENTED /* integral unshared stack size */ 尚未实现
    ru_minflt: isize,      // NOT IMPLEMENTED /* page reclaims (soft page faults) */ 尚未实现
    ru_majflt: isize,      // NOT IMPLEMENTED /* page faults (hard page faults) */ 尚未实现
    ru_nswap: isize,       // NOT IMPLEMENTED /* swaps */ 尚未实现
    ru_inblock: isize,     // NOT IMPLEMENTED /* block input operations */ 尚未实现
    ru_oublock: isize,     // NOT IMPLEMENTED /* block output operations */ 尚未实现
    ru_msgsnd: isize,      // NOT IMPLEMENTED /* IPC messages sent */ 尚未实现
    ru_msgrcv: isize,      // NOT IMPLEMENTED /* IPC messages received */ 尚未实现
    ru_nsignals: isize,    // NOT IMPLEMENTED /* signals received */ 尚未实现
    ru_nvcsw: isize,       // NOT IMPLEMENTED /* voluntary context switches */ 尚未实现
    ru_nivcsw: isize,      // NOT IMPLEMENTED /* involuntary context switches */ 尚未实现
}
...
impl TaskControlBlock {
    ...
    pub fn new(elf: FileDescriptor) -> Self {
        ...
        *trap_cx = TrapContext::app_init_context( //初始化trap上下文
            elf_info.entry,
            ustack_bottom_from_tid(tid),  //用户栈
    ...
    pub fn get_user_token(&self) -> usize { //物理页的标识符（token）
        self.vm.lock().token()
    }
}
